...
def stellaRun():
    ...
    thread.start_new_thread(fr.fakeNewRunFromCSV, (csvOfRun, 1, 196, "ecY8eksEf3", "delta", "pwd"))
...
def stellaShortRun():
    ...
    thread.start_new_thread(fr.fakeNewRunFromCSV, (csvOfRun, 1, 112, "ecY8eksEf3", "delta", "pwd"))
    return "<h1> Stella is running! </h1>"
...
def moliriCheer():
    ...
    thread.start_new_thread(fr.fakeNewCheerFromCSV, (csvOfRun, 1, 261, "8hNTsRiLzK", "moliri", "pwd"))
